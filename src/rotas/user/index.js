...
async function getBoostInfo(
  ...
  let bannerUrl;
  if (banner) {
    bannerUrl = `https://cdn.discordapp.com/banners/${id}/${banner}.${banner.startsWith("a_") ? "gif?size=4096" : "png?size=4096"}`;
  } else {
    bannerUrl = null;
  }
    ...
    if (!appInfo.verified) {
      return {
        ...
        profile: {
          ...
          avatarUrl: avatar || `https://cdn.discordapp.com/embed/avatars/${Number(discrim) % 5}.png`,
        },
